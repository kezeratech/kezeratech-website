  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="font-heading text-2xl font-bold tracking-tight">Edit News Article</h1>
          <p className="mt-1 text-sm text-muted-foreground">Update this news article.</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
        <Card className="space-y-5 p-6">
          ...
          <div className="space-y-2">
            <Label>Excerpt</Label>
            <Textarea value={form.excerpt} onChange={(e) => set('excerpt', e.target.value)} className="min-h-20" />
          </div>
          <div className="space-y-2">
            <Label>Content</Label>
